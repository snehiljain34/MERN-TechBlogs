...
Hey 🖐 this is a basic mern blogging website which has 
-> Home Page 
->Posts lists page 
-> post page.
It renders posts from mongoDB and shows in post page. Posts are stored as JSON objects sent through "INSOMNIA" app. 
...
## Installation:
  ...
  ```bash
  git clone https://github.com/snehiljain34/MERN-TechBlogs.git
  ```
  ### `Go to /techblog-backend/`
